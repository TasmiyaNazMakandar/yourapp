...
//getUsers service method
  ...
  static Future<List<ScheduleList>> getSchedule() async {
    String apiUrl = ApiUrlConstants.getSchedules;

    final json = {
      "memberId": 1,
      "appointmentStartDate": "2021-02-09T08:07:33.432Z",
      "appointmentEndDate": "2021-02-09T08:07:33.432Z",
      "locationId": null,
      "patientSearchString": null,
      "dictationStatusId": null,
      "providerId": null,
      "page": 1
    };
